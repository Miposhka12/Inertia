...
# ВСТАВЛЕННЫЕ ТОКЕНЫ
BOT_TOKEN = "8093617227:AAFqJV9Kqd4XmcmCX_qgiNo-gnmgR-W575Y"
    ...
    try:
        ...
        result = client.chat.completions.create(
            ...
            messages=[
                {
                    "role": "system",
                    "content": "Ты анализируешь стиль Telegram-канала по 15 критериям и возвращаешь результат в формате JSON.",
                },
